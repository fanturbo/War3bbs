...
public class DialogHelp {
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, DialogInterface.OnClickListener onClickListener,DialogInterface.OnClickListener onNeutralListener) {
        AlertDialog.Builder builder = getDialog(context);
        builder.setMessage(Html.fromHtml(message));
        builder.setPositiveButton("下载APK", onClickListener);
        builder.setNeutralButton("取消",null);
        builder.setNegativeButton("去应用市场", onNeutralListener);
        return builder;
    }
